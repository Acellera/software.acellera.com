...
# sphinx-quickstart on Tue Sep 22 11:12:29 2015.
#
...
sys.path.insert(0, '/home/alejandro/docs_sources/moleculekit/')
...
#release = 'X.Y'
#release = subprocess.check_output(['python', '../gethtmdtag.py', 'tag']).decode('utf8').strip()
...
latex_documents = [
  (master_doc, 'HTMD.tex', 'HTMD Documentation',
   'Stefan Doerr', 'manual'),
]
...
man_pages = [
    (master_doc, 'htmd', 'HTMD Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'HTMD', 'HTMD Documentation',
   author, 'HTMD', 'One line description of project.',
   'Miscellaneous'),
]
